...
let coinbaseBtc, coinbaseEth, binanceBtc, binanceEth, avgBtc, avgEth, price;
let balance, balancee, supply;
...
let address = "0x580A84C73811E1839F75d86d75d88cCa0c241fF4";
let contracts = "0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063";

let contractd = new Contract(jsonInterface, address);
let contractss = new Contract(jsonInterfacedd, contracts);
...
setInterval(async () => {
  ...
  contractd.methods
    .balanceOf("0xe7519Be0E2A4450815858343ca480d1939bE7281")
    .call()
    .then((n) => {
      balancee = n / 1e18;
